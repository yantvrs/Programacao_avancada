...
valores de x+1, x+2 e x+3 se:
   ...
   SE O ENDEREÇO TIVER EM BITS:
? x for declarado como char? 4092 , 4100 , 4108 , 4116 (bits)
? x for declarado como int? 4092 , 4108 , 4124 , 4140  (bits)
? x for declarado como float? 4092 , 4124 , 4156 , 4188 (bits)
? x for declarado como double? 4092 , 4156 , 4220 , 4284 (bits)
